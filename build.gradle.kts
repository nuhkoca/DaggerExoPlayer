...
buildscript {
    ...
    dependencies {
        ...
        classpath("org.jetbrains.kotlin:kotlin-gradle-plugin:${Versions.kotlin_gradle_version}")
        classpath("org.jetbrains.dokka:dokka-android-gradle-plugin:${Versions.dokka_version}")
    }
}
