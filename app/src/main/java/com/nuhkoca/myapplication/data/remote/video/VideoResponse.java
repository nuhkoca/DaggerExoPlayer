...
public class VideoResponse extends BaseObservable {
  ...
  public static DiffUtil.ItemCallback<VideoResponse> DIFF_CALLBACK = new DiffUtil.ItemCallback<VideoResponse>() {
    @Override public boolean areItemsTheSame(@NonNull VideoResponse oldItem, @NonNull VideoResponse newItem) {
      return oldItem.uri.equals(newItem.uri);
    }

    @Override public boolean areContentsTheSame(@NonNull VideoResponse oldItem, @NonNull VideoResponse newItem) {
      return oldItem.equals(newItem);
    }
  };

  @Expose @SerializedName("uri") private String uri;
  @Expose @SerializedName("name") private String name;
  @Expose @SerializedName("description") private String description;
  @Expose @SerializedName("pictures") private Pictures pictures;
  @Expose @SerializedName("status") private String status;
  @Expose @SerializedName("duration") private int duration;

  @Bindable public String getUri() {
    return uri;
  }
  ...
  @Bindable public Pictures getPictures() {
    return pictures;
  }
