...
interface IPaginationCallback<Wrapper, Result> {
     ...
     */
    fun onInitialSuccess(wrapper: Wrapper, callback: PageKeyedDataSource.LoadInitialCallback<Int, Result>, model: MutableList<Result>)
     ...
     * @param model    represents the actual response
     */
    fun onPaginationSuccess(wrapper: Wrapper, callback: PageKeyedDataSource.LoadCallback<Int, Result>, params: PageKeyedDataSource.LoadParams<Int>, model: MutableList<Result>)
